        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className="text-gray-700 hover:text-[#778259] px-3 py-2 text-sm font-medium relative group"
              >
                {item.name}
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-gray-700 hover:text-[#778259]"
            >
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
              {navItems.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-[#778259] hover:bg-gray-50 rounded-md"
